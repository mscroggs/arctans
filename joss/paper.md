...
and functions that generate arctangent sum formulae equivalent formulae that are passes an an input: if a list Machin-like formulae are input, this would then generate
